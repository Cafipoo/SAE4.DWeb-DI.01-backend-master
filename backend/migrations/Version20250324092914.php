 ...
 */
final class Version20250324092914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_interaction ADD post_id INT NOT NULL, ADD user_id INT NOT NULL, DROP id_post_id, DROP id_user_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_interaction ADD id_post_id INT NOT NULL, ADD id_user_id INT NOT NULL, DROP post_id, DROP user_id');
