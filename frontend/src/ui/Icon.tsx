...
const Icon = ({ name, className = "w-6 h-6" }: IconProps) => {
  const icons = {
    ...
    profile: (<path fill="currentColor" fillRule="evenodd" d="M8 7a4 4 0 1 1 8 0a4 4 0 0 1-8 0m0 6a5 5 0 0 0-5 5a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3a5 5 0 0 0-5-5z" clipRule="evenodd"/>
    ),
    settings: (
    ...
    search: (
      <path d="M21.53 20.47l-3.66-3.66A8.98 8.98 0 0 0 20 11a9 9 0 1 0-9 9c2.215 0 4.24-.804 5.808-2.13l3.66 3.66a.746.746 0 0 0 1.06 0 .747.747 0 0 0 .002-1.06zM11 17c-3.308 0-6-2.692-6-6s2.692-6 6-6 6 2.692 6 6-2.692 6-6 6z" />
    ),
    play: (
    ...
    pinned: (
      <path fill="currentColor" d="M24 22.179c.361.361.932.361 1.269 0a.89.89 0 0 0 0-1.269L4.325.35a.914.914 0 0 0-1.281 0c-.338.338-.338.931 0 1.269ZM17.982 12.108l.675-4.878c.024-.256.07-.408.303-.559l2.829-2.049c.64-.466.908-1.036.908-1.56c0-.78-.617-1.467-1.525-1.467H7.469ZM6.584 18.756h6.217V24.74c0 1.77.745 3.26 1.025 3.26c.291 0 1.036-1.49 1.036-3.26V18.756h3.272l-8.755-8.755l.198 1.479c.07.477-.093.664-.326.92l-3.563 3.865c-.338.361-.489.71-.489 1.199c0 .78.571 1.293 1.386 1.293"/>
    ),
    notification: (
      <path d="M12 22a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm0 2a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16z" />
    ),
    limited: (
      <>
        <path d="M1.751 10c0-4.42 3.584-8 8.005-8h4.366c4.49 0 8.129 3.64 8.129 8.13 0 2.96-1.607 5.68-4.196 7.11l-8.054 4.46v-3.69h-.067c-4.49.1-8.183-3.51-8.183-8.01zm8.005-6c-3.317 0-6.005 2.69-6.005 6 0 3.37 2.77 6.08 6.138 6.01l.351-.01h1.761v2.3l5.087-2.81c1.951-1.08 3.163-3.13 3.163-5.36 0-3.39-2.744-6.13-6.129-6.13H9.756z" />
