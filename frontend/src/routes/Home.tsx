...
const Home = () => {
  ...
  return (
    <div className="flex justify-center md:gap-4 min-h-screen bg-black">
      ...
      <main className="flex-1 border-l border-r md:border-dark-secondary md:ml-72 md:max-w-[600px]">
        <header className="sticky top-0 z-10 border-b border-dark-secondary backdrop-blur">
        ...
        <div className="flex justify-end px-4 py-2">
          <div 
            className="flex items-center gap-2 cursor-pointer hover:bg-dark-secondary p-2 rounded-full transition-colors"
